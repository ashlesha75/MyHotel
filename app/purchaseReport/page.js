...
// //                 <th className="py-1 px-4 border-b">Grand Total</th>
...
// //                           </td> */}
// //                           <td className="py-1 px-4 border-b">
// //                             {item.gstAmount ? item.gstAmount.toFixed(2).padStart(5, "0") : "0"}
// //                           </td>
// //                           {/* <td className="py-2 px-4 border-b">
...
//         <th className="py-1 px-4 border-b">Price/Unit</th>
//         <th className="py-1 px-4 border-b">GST Amt</th>
//         <th className="py-1 px-4 border-b">Total</th>
//       </tr>
//     </thead>
//     <tbody className="text-sm">
//       {filteredPurchases.length > 0 && (
...
//                 <td className="py-2 px-4 border-b">Discount: {purchase.discount ? purchase.discount.toFixed(2).padStart(5, "0") : "00.00"}</td>
//                 <td className="py-2 px-4 border-b">Paid Amount: {purchase.paidAmount ? purchase.paidAmount.toFixed(2).padStart(5, "0") : "00.00"}</td>
//                 <td className="py-2 px-4 border-b text-red-500">Balance: {purchase.balance ? purchase.balance.toFixed(2).padStart(5, "0") : "00.00"}</td>
//                 {/* <td className="py-2 px-4 border-b text-red-500">total: {purchase.subtotal ? purchase.subtotal.toFixed(2).padStart(5, "0") : "00.00"}</td> */}
//               </tr>
//             </React.Fragment>
//           ))}
//         </>
