...
//   //   return {
//   //     ...orderItem,
//   //     selectedTaste: selectedTaste || { _id: null, taste: "" }, // Ensure selectedTaste is not null
//   //   };
//   // });
...
//           {/* <!-- left section --> */}
//           <div className=" w-60 lg:w-3/5  xl: shadow-lg md:w-96 sm:w-8">
//             {/* <!-- header --> */}
...
//             <div
//               className="cursor-pointer grid grid-cols-1 bg-white  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4
//              px-3 mt-3 custom-sidescrollbars overflow-scroll lg:max-h-[calc(82vh-1rem)] 
//              md:max-h-[calc(80vh-1rem)]   max-h-[calc(134vh-1rem)]  sm:max-h-[calc(16vh-1rem)] "
//             >
//               {(menus.menus || menus)
...
//                     h-28 justify-between text-sm sm:h-24 lg:h-32 lg:w-40 "
...
//                 className="mt-1 p-1 border rounded-md text-xs text-gray-400 lg:ml-4 md:ml-4 ml-10 "
//                 required
//               >
...
//             {/* <!-- end header --> */}
//             {/* <!-- order list --> */}
//             <div className="p-2 custom-scrollbars overflow-y-auto lg:h-72 md:h-40 h-96 lg:text-sm md:text-sm text-xs">
//               {currentOrder.map((orderItem) => (
//                 <div key={orderItem._id} className="flex items-center mb-3">
//                   <div className="flex flex-row items-center ">
//                     <div className="flex items-center h-full">

//                       <span className=" font-semibold  lg:w-52 md:w-32 w-20 sm:text-xs md:text-xs   lg:text-base lg:ml-1 text-xs">
//                         {orderItem.name}
//                       </span>
//                     </div>
//                   </div>
...
//                   <div className="flex flex-col  md:flex-row items-center lg:text-sm md:text-sm text-xs sm:flex">
...
//                       }
//                       className="mt-1 p-1 lg:-ml-3  lg:w-32 w-16 ml-1 md:-ml-3 sm:ml-0 align-middle  text-center border rounded-md text-xs  text-gray-500 lg:text-sm md:text-xs "
//                       required
//                     />
...
//             {/* <!-- button pay--> */}
//             <div className="flex flex-wrap px-1 mt-2 justify-center md:gap-3    lg:gap-1  sm:gap-2">
      ...
      <div className="container mx-auto bg-white">
         ...
         */}
          ...
          <div className=" w-80 lg:w-2/5 bg-gray-200 md:w-96">
            ...
            {/* <!-- end header --> */}
            {/* <!-- order list --> */}
            <div className="p-1 custom-scrollbars overflow-y-auto lg:h-72 md:h-40  max-h-[calc(96vh-1rem)] lg:text-sm md:text-sm text-xs">
              {currentOrder.map((orderItem) => (
                  ...
                  */}
                  ...
                  <div className="flex   md:flex-row items-center lg:text-sm md:text-sm text-xs sm:flex">
                    ...
                    <input
                      ...
                      className="mt-1 p-1 lg:-ml-3  lg:w-32  w-20  md:-ml-3 sm:ml-0 align-middle  text-center border rounded-md text-xs  text-gray-500 lg:text-sm md:text-xs "
                      required
                    />
                  ...
                  <div className="font-semibold  lg:text-lg md:text-md text-xs mt-1  text-right lg:ml-1  ml-1 lg:mt-0  md:mt-0 sm:mt-0  sm:text-xs sm:w-20 ">
                    {`₹${(orderItem.price * orderItem.quantity).toFixed(2)}`}
                  </div>
                </div>
              ))}
