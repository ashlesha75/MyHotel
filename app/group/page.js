...
import { faHouse, faTrash, faCheck, faTimes, } from "@fortawesome/free-solid-svg-icons";
    ...
    <>
      ...
      <div>
        ...
        <div className=" bg-black font-sans">
          ...
          >
            <div className=" flex justify-center h-full font-sans">
      ...
      <div className="max-w-4xl mx-auto mt-2 p-4 rounded-md flex flex-col md:flex-row bg-gray-50 font-sans">
        ...
        <h1 className="text-xl font-bold font-sans mb-2 md:mb-0 text-orange-600">Group Menus</h1>
