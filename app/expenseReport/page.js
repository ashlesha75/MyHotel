    ...
    <>
      ...
      <div className="container mx-auto mt-10 p-2 bg-white rounded-md shadow-md font-sans">
        ...
        <div className="mb-4 flex flex-wrap items-center">
          ...
          <div>
            <select
              className="border rounded-md p-1 text-gray-700 text-sm mb-2 ml-2"
          ...
          <div className="flex flex-wrap justify-between">
            <button
              className="bg-green-100 text-green-600 text-sm px-4 py-2 mr-3 rounded-full font-bold lg:ml-2 hover:bg-green-200 focus:outline-none focus:shadow-outline-green mb-2"
            ...
            <button
              className="bg-blue-100 text-blue-600 text-sm px-4 py-2 rounded-full font-bold hover:bg-blue-200 focus:outline-none focus:shadow-outline-blue mb-2"
