    ...
    const displayMenus = filterMenus()
        ...
        .map((menu, index) => (
            ...
            >
                ...
                <td className="p-2 text-center text-gray text-orange-400">{menu.uniqueId}</td>
        ...
        <>
            ...
            <div className="container mx-auto p-2 w-full mt-12 overflow-x-auto  border-gray-300 shadow-md font-sans max-w-5xl">
                <div className="flex flex-col md:flex-row items-center justify-between mb-4">
                    <h1 className="text-xl font-bold font-sans mb-2 md:mb-0 text-orange-600">Menu List</h1>
                ...
                <table className="min-w-full mt-4">
                    <thead className="text-base bg-zinc-100 text-yellow-700 border">
                        <tr>
                            ...
                            <th className="text-left text-gray lg:pl-36 pl-4">Menu Name</th>
