        ...
        {isMobile && (
          <div className="absolute top-16 left-0 right-0 bg-gray-200 text-black  flex flex-col z-50">
            ...
            <div className="relative group inline-block mt-3">
              ...
              <ul className="bg-slate-50 border rounded-md transform scale-0 group-hover:scale-100 absolute transition duration-150 ease-in-out origin-top-left min-w-32 z-30">
              <li className="rounded-md px-4 whitespace-nowrap">
                  <Link href="/tables">
                    <button className="outline-none focus:outline-none px-3 rounded-md flex items-center text-black border-t">
                      <span className="pr-1 flex-1 text-black font-semibold">Table Master </span>
                    </button>
                  </Link>
                </li>
                <li className="rounded-md px-4 whitespace-nowrap">
                  <Link href="/section">
                    <button className="outline-none focus:outline-none px-3 rounded-md flex items-center text-black border-t">
                      <span className="pr-1 flex-1 text-black font-semibold">Section Master </span>
                    </button>
                  </Link>
                </li>
                <li className="rounded-md px-4 whitespace-nowrap">
                ...
                <li className="rounded-md px-4 whitespace-nowrap">
                  <Link href="/bankName">
                    <button className="outline-none focus:outline-none px-3 rounded-md flex items-center text-black border-t">
                      <span className="pr-1 flex-1 text-black font-semibold">Bank Name Master</span>
                    </button>
                  </Link>
                </li>
                <li className="rounded-md px-4 whitespace-nowrap">
